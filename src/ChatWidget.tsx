...
export interface ChatWidgetProps {
  ...
  initialMessages?: any[];
  /**
   * Per-turn context (#162, #239): a static object, `'auto'` for the built-in
   * safe page capture, or a function resolved fresh at send time. See
   * `buildAutoPageContext` for opting into richer capture. Untrusted
   * server-side until the handler opts in via `getContext` /
   * `trustClientContext`.
   */
